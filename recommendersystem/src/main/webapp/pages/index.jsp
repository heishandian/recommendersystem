...
<meta name="description"
	content="Movies, intelligent, recommendation system " />
<meta name="keywords"
	content="Movies, intelligent, recommendation system" />
...
<body>
	<div class="wrapper">
		<h1>
			Movies intelligent <br>recommendation system
		</h1>
			...
			<div id="form_wrapper" class="form_wrapper">
				...
				<form class="register">
					...
					<div class="bottom">
						...
						<input type="submit" value="Register" /> <a href="index.html" rel="login" class="linkform">You have an account already? Login here</a>
						<div class="clear"></div>
					</div>
				</form>
				...
				<form class="login active">
					...
					<div>
						...
						<span class="error" style="border:1px solid red">This is an error</span>
					</div>
					<div>
						<label>Password: <a href="forgot_password.html" rel="forgot_password" class="forgot linkform">Forgot your password?</a> </label> <input type="password" id="password" />
					...
					<div class="bottom">
						<div class="remember">
							...
							<input type="submit" value="Login" id="submit" onclick=""></input> 
